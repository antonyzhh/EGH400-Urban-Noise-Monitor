...
def classification():
    ...
    ##CONTROLS
    GENERATE_IMGS = True #Classification Imgs
    CLASSIFY = True

    #Load Model
    active_model = models.active_model()
    load_mod = "MODEL/"+active_model
    ...
    if GENERATE_IMGS:
        exec(open(OS_path+"generate_images_classify.py").read())
        print('\n')
    ...
    #Generate the 'for classification' dataset
    class Classify():
        RESIZE_WIDTH = 99
